# onlineInsurance
Basic online insurance app

You have to design & build the backend for the application and the ability for the users to register, search, buy insurance etc.
...
https://github.com/azaylamba/onlineInsurance 
